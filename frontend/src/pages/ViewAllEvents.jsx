              ...
              <div key={event._id} className="event-card">
                {event.imageUrl && (
                  <img
                    ...
                    onError={(e) => {
                      e.target.src =
                        "https://placehold.co/300x200/e0e0e0/555555?text=No+Image";
                    }}
                  />
                )}
                <div className="event-card-content">
                  ...
                  <p className="event-detail">
                    <FaCalendarAlt className="event-icon" /> Date:{" "}
                  ...
                  <p className="event-detail event-verified">
                    ...
                    Verified: {event.isVerified ? "Yes" : "No"}
                  </p>
                          ...
                          {event.organizer.designation &&
                            event.organizer.company && (
                              <p className="organizer-job">
                                <FaBriefcase /> {event.organizer.designation}{" "}
                                <FaBuilding /> {event.organizer.company}
                              </p>
                            )}
