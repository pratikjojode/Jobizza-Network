          ...
          <form onSubmit={handleSubmit} className="jobizaaa-auth-form">
            ...
            {isRegister && (
              <div className="jobizaaa-scroll-panel">
                {" "}
                {/* Scrollable panel for registration fields */}
                ...
                <div className="jobizaaa-form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setYearsOfFinanceExperience(e.target.value)
                    }
                    className="jobizaaa-form-input"
            ...
            {!isRegister && (
              <>
                <p className="jobizaaa-form-label jobizaaa-role-selection-label">
                  Login as Role:
                </p>
                <div className="jobizaaa-role-cards-container">
                  ...
                  {cLevelRoles.map((r) => (
                    <div
                      key={r}
                      className={`jobizaaa-role-card ${
                        role === r ? "jobizaaa-role-card-selected" : ""
                      }`}
                      onClick={() => setRole(r)}
            ...
            {!isRegister && (
              <div className="jobizaaa-forgot-password-link">
                <Link to="/forgot-password" className="jobizaaa-link">
                  Forgot Password?
                </Link>
              </div>
            )}
